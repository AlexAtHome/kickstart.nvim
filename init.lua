...
do
	...
	vim.api.nvim_create_autocmd('TextYankPost', {
		desc = 'Highttps://github.com/hlight when yanking (copying) text',
...
do
	...
	require('conform').setup {
		...
		formatters = {
			prettier = {
				cwd = function() return require('conform.util').root_file { '.prettierrc', '.prettierrc.json', '.prettierrc.js', 'prettier.config.js' } end,
				require_cwd = true,
			},
		},
	}
